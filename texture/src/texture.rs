...
fn expand_format_channels(format: Format) -> Option<(Format, BufferTransform, Swizzle)> {
    ...
    Some(match format {
        ...
        Format::Rg8Snorm => (Format::Rgba8Snorm, t2to4_8, rgzo),
        Format::Rg8Uscaled => (Format::Rgba8Uscaled, t2to4_8, rgzo),
        Format::Rg8Sscaled => (Format::Rgba8Sscaled, t2to4_8, rgzo),
        Format::Rg8Uint => (Format::Rgba8Uint, t2to4_8, rgzo),
        Format::Rg8Sint => (Format::Rgba8Sint, t2to4_8, rgzo),
        Format::Rg8Srgb => (Format::Rgba8Srgb, t2to4_8, rgzo),

        Format::Rgb8Unorm => (Format::Rgba8Unorm, t3to4_8, rgbo),
        Format::Rgb8Snorm => (Format::Rgba8Snorm, t3to4_8, rgbo),
        Format::Rgb8Uscaled => (Format::Rgba8Uscaled, t3to4_8, rgbo),
        Format::Rgb8Sscaled => (Format::Rgba8Sscaled, t3to4_8, rgbo),
        Format::Rgb8Uint => (Format::Rgba8Uint, t3to4_8, rgbo),
        Format::Rgb8Sint => (Format::Rgba8Sint, t3to4_8, rgbo),
        Format::Rgb8Srgb => (Format::Rgba8Srgb, t3to4_8, rgbo),

        Format::Bgr8Unorm => (Format::Rgba8Unorm, t3to4_8, bgro),
        Format::Bgr8Snorm => (Format::Rgba8Snorm, t3to4_8, bgro),
        Format::Bgr8Uscaled => (Format::Rgba8Uscaled, t3to4_8, bgro),
        Format::Bgr8Sscaled => (Format::Rgba8Sscaled, t3to4_8, bgro),
        Format::Bgr8Uint => (Format::Rgba8Uint, t3to4_8, bgro),
        Format::Bgr8Sint => (Format::Rgba8Sint, t3to4_8, bgro),
        Format::Bgr8Srgb => (Format::Rgba8Srgb, t3to4_8, bgro),

        Format::Bgra8Unorm => (Format::Rgba8Unorm, t3to4_8, bgra),
        Format::Bgra8Snorm => (Format::Rgba8Snorm, t3to4_8, bgra),
        Format::Bgra8Uscaled => (Format::Rgba8Uscaled, t3to4_8, bgra),
        Format::Bgra8Sscaled => (Format::Rgba8Sscaled, t3to4_8, bgra),
        Format::Bgra8Uint => (Format::Rgba8Uint, t3to4_8, bgra),
        Format::Bgra8Sint => (Format::Rgba8Sint, t3to4_8, bgra),
        Format::Bgra8Srgb => (Format::Rgba8Srgb, t3to4_8, bgra),

        Format::Rg16Unorm => (Format::Rgba16Unorm, t2to4_16, rgzo),
        Format::Rg16Snorm => (Format::Rgba16Snorm, t2to4_16, rgzo),
        Format::Rg16Uscaled => (Format::Rgba16Uscaled, t2to4_16, rgzo),
        Format::Rg16Sscaled => (Format::Rgba16Sscaled, t2to4_16, rgzo),
        Format::Rg16Uint => (Format::Rgba16Uint, t2to4_16, rgzo),
        Format::Rg16Sint => (Format::Rgba16Sint, t2to4_16, rgzo),
        Format::Rg16Sfloat => (Format::Rgba16Sfloat, t2to4_16, rgzo),

        Format::Rgb16Unorm => (Format::Rgba16Unorm, t3to4_16, rgbo),
        Format::Rgb16Snorm => (Format::Rgba16Snorm, t3to4_16, rgbo),
        Format::Rgb16Uscaled => (Format::Rgba16Uscaled, t3to4_16, rgbo),
        Format::Rgb16Sscaled => (Format::Rgba16Sscaled, t3to4_16, rgbo),
        Format::Rgb16Uint => (Format::Rgba16Uint, t3to4_16, rgbo),
        Format::Rgb16Sint => (Format::Rgba16Sint, t3to4_16, rgbo),
        Format::Rgb16Sfloat => (Format::Rgba16Sfloat, t3to4_16, rgbo),

        Format::Rg32Uint => (Format::Rgba32Uint, t2to4_32, rgzo),
        Format::Rg32Sint => (Format::Rgba32Sint, t2to4_32, rgzo),
        Format::Rg32Sfloat => (Format::Rgba32Sfloat, t2to4_32, rgzo),

        Format::Rgb32Uint => (Format::Rgba32Uint, t3to4_32, rgbo),
        Format::Rgb32Sint => (Format::Rgba32Sint, t3to4_32, rgbo),
        Format::Rgb32Sfloat => (Format::Rgba32Sfloat, t3to4_32, rgbo),
